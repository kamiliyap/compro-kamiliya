              ...
              <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4">
                  <div class="lgx-single-speaker lgx-single-speaker-circle">
                    <figure>
                      <a class="profile-img" href="speakers.html"><img src="{{ asset('fe/assets/img/schedule/speaker1.jpg') }}" alt="speaker" /></a>
                      <figcaption>
                        ...
                        <div class="speaker-info">
                          <h3 class="title"><a href="speaker.html">Kamiliya Latifah Prasmaisya</a></h3>
              ...
              <div class="row">
                @foreach ($blogs as $blog)
                    ...
                    <div class="lgx-single-news">
                        <figure>
                        <a href="#"><img src="{{ asset('storage/'.$blog->photo) }}" alt="{{ $blog->title }}" /></a>
                        </figure>
                        <div class="single-news-info">
                        <div class="meta-wrapper">
                            <span>{{ $blog->created_at->format('d, F, Y') }}</span>
                            <span>by <a href="#">{{ auth()->user()->name ?? ''}}</a></span>
